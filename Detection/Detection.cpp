...
void export_parser()
{
    ...
    //profile->setDimensions("onnx::Concat_0", nvinfer1::OptProfileSelector::kMIN, nvinfer1::Dims4{ 1, 100, 1, 1 });
    //profile->setDimensions("onnx::Concat_0", nvinfer1::OptProfileSelector::kOPT, nvinfer1::Dims4{ 10, 100, 1, 1 });
    //profile->setDimensions("onnx::Concat_0", nvinfer1::OptProfileSelector::kMAX, nvinfer1::Dims4{ 100, 100, 1, 1 });
    //profile->setDimensions("onnx::Concat_1", nvinfer1::OptProfileSelector::kMIN, nvinfer1::Dims4{ 1, 10, 1, 1 });
    //profile->setDimensions("onnx::Concat_1", nvinfer1::OptProfileSelector::kOPT, nvinfer1::Dims4{ 10, 10, 1, 1 });
    //profile->setDimensions("onnx::Concat_1", nvinfer1::OptProfileSelector::kMAX, nvinfer1::Dims4{ 100, 10, 1, 1 });
...
void inference_parser()
{
    ...
    nvinfer1::Dims2 outputDims = { 10, 10 };
    ...
    for (int i = 0; i < 10; i += 1)
    {
        ...
        cv::imwrite("D:\\model\\acgan\\_parser_" + std::to_string(i) + ".jpg", image);
    }
...
void inference_api()
{
    ...
    std::cout << "input0 dims: " << idims0.d[0] << " " << idims0.d[1] << " " << idims0.d[2] << " " << idims0.d[3] << std::endl;
    std::cout << "input1 dims: " << idims1.d[0] << " " << idims1.d[1] << " " << idims1.d[2] << " " << idims1.d[3] << std::endl;
    std::cout << "output1 dims: " << odims.d[0] << " " << odims.d[1] << " " << odims.d[2] << " " << odims.d[3] << std::endl;
    nvinfer1::Dims4 inputDims0 = { 10, idims0.d[1], idims0.d[2], idims0.d[3] };
    nvinfer1::Dims4 inputDims1 = { 10, idims1.d[1], idims1.d[2], idims1.d[3] };
    nvinfer1::Dims2 outputDims = { 10, 10 };
